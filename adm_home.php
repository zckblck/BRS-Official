...
<html>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            google.charts.setOnLoadCallback(drawChart_total_items);

            // Draw the chart and set the chart values
            function drawChart_total_items() {
              var data = google.visualization.arrayToDataTable([
              ['Task', 'Hours per Day'],
              ['Work', 8],
              ['Eat', 2],
              ...
              // Optional; add a title and set the width and height of the chart
              var options = {'title':'Total Items', 'width':550, 'height':400};

              // Display the chart inside the <div> element with id="piechart"
              var chart = new google.visualization.PieChart(document.getElementById('total_items_chart'));
              chart.draw(data, options);
            }
